...
let lvl_description = [
    ["We started where and how everyone in rust begins. as a naked on the beach(itch)", "profile_lvl0.jpg"],
    ["2x2 Base, íjászmester","profile_lvl1.png"],
    ["2x2 Base, but make it stone!","profile_lvl2.jpg"],
    ["Let's raid!", "profile_lvl3.jpg"]
];
...
function favagas(){
    ...
    if(szazalek <= 20){
        //sebződés
        // story.innerHTML += "Eltört a kezed! (-5 élet)<br>";
        // stats.life -= 5;

        harc(" Roofcamper", 100, 8);

        refreshProfileStats();
    } else{
        //sikeres favágás
        story.innerHTML += "Sikeres scrappelés! (+10 scrap)<br>";
        stats.experience += 1;
        refreshProfileStats();
    }
}
    ...
    do {
        ...
        if(ellenfel_tamad){
            ...
            if(szazalek > elkerules){
                story.innerHTML += "Elkerülöd "+e_name+" félelmetes boltiját!<br>";
            }else{
